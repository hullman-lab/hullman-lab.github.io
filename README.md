# Epistemic Decisions Lab Website

This repository hosts the in-progress site for Jessica Hullman's Epistemic Decisions Lab. Our lab site is built with `Jekyll` and this repo stores all supporting assets (e.g., images, paper PDFs, metadata, etc.).
